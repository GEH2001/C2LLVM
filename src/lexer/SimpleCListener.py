...
class SimpleCListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by SimpleCParser#exprfloat.
    def enterExprfloat(self, ctx:SimpleCParser.ExprfloatContext):
        pass

    # Exit a parse tree produced by SimpleCParser#exprfloat.
    def exitExprfloat(self, ctx:SimpleCParser.ExprfloatContext):
        pass
    ...
    # Enter a parse tree produced by SimpleCParser#float.
    def enterFloat(self, ctx:SimpleCParser.FloatContext):
        pass

    # Exit a parse tree produced by SimpleCParser#float.
    def exitFloat(self, ctx:SimpleCParser.FloatContext):
        pass
